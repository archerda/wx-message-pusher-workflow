...
4. Download the [wx-message-pusher.alfredworkflow](https://github.com/archerda/wx-message-pusher-workflow/blob/master/bin/wx-message-pusher.alfredworkflow) file & double click it to install in Alfred;
